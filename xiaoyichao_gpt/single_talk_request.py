"""req_wenxin pub
    ...
    nohup  python  xiaoyichao_gpt/single_talk_request.py --bot_type minimax --task retie > "./logs/minimax_retie_$(date +"%Y-%m-%d-%H").log" 2>&1 &
    ...
    nohup  python  xiaoyichao_gpt/single_talk_request.py --bot_type minimax --task qunliao > "./logs/minimax_qunliao_$(date +"%Y-%m-%d-%H").log" 2>&1 &
...
if __name__ == '__main__':
    ...
    # for i in range(200,300,1):
        ...
        if args.bot_type == "yiyan": # 请求wenxin
            ...
            print("{} minimax_res:{}".format(i, res_minimax))
            # time.sleep(3)
